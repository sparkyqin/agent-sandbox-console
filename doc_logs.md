> For the complete documentation index, see [llms.txt](https://docs.portainer.io/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://docs.portainer.io/user/docker/containers/logs.md).

# View container logs

From the menu select **Containers**, select the container then select **Logs**.

<figure><img src="/files/lPVBqddn35zp4Umf48xC" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/8JoGUFkBUz9Evn5WjlLG" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/3XgV2r9HNbkPH0ab5JUi" alt=""><figcaption></figcaption></figure>
